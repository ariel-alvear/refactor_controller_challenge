class CartsController < ApplicationController
  ...
  def process_paypal_payment
    ...
    express_purchase_options = express_purchase_options(request, params[:token], details)
    price = details.params["order_total"]
    to_decimal_per_100(price)
